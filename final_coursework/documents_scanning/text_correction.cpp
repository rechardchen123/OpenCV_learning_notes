...
*Function List:  //主要函数列表，每条记录应包含函数名及功能简要说明
               1. double DegreeTran(doubke theta) 
               2. void rotateImage(Mat src, Mat &img_rotate, double degree)
               3. double CalcDegree(const Mat &srcImage, Mat &dst)
               4. void ImageRecify(const char *pInFileName)
