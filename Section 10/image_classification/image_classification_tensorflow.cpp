/*
Use the tensorflow trained model to classify the images
...
int main(){
    string weightFile = "/home/richardchen123/Documents/data/models/tensorflow_inception_graph.pb";

    Mat frame = imread("../data/images/panda.jpg");

    string classFile = "/home/richardchen123/Documents/data/models/imagenet_comp_graph_label_strings.txt";  
